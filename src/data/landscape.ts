...
const rawRoads:typeof roadGuides=[...(routeData as typeof roadGuides).filter((_,i)=>retained.has(i)).map(r=>r===routeData[12]?{...r,points:r.points.map(([u,v])=>u===1064?[1069,572] as Point:[u,v] as Point)}:r),
 ...
 // Overhead reference: straight runs parallel to the research wings. The
 ...
 route('求是路',6,[[410,33],[410,250.956],[410,303.596]]),
 route('明德路',10,[[538.446,33],[538.446,350]]),
 route('博雅路',4,[[653.124,33],[653.124,303.596]]),
 ...[87.026,143.566,196.916,250.956,303.596].map((z,i)=>route(i===1?'研学二路':'科研楼组团横向道路',8,[[410,z],[538.446,z],[653.124,z]])),
 ...
 route('东侧环教路',8,[[538.446,350],[570,340],[615,335],[725,280],[760,240],[775,220],[770,165],[750,150],[653.124,150],[653.124,143.566]]),
 ...
 route('教学楼组团横向道路',8,[[394,-43.625],[592,-43.625],[592,33]]),
 route('教学区东北侧通道',6,[[394,-110],[550,-110],[576,-105],[592,-88],[592,-43.625]]),
];
...
// User's satellite crop: a narrow fork west of the football/basketball courts,
...
southOneRoad.points=ground([[-360,130.8],[-300,110],[-280,130],[-250,140],[-205,140],[-184,136],[-160,127],[-135,118],[-108,113],[-75,111],sportsFork]);
