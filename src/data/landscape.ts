...
export const roads:typeof roadGuides=[...(routeData as typeof roadGuides).filter((_,i)=>retained.has(i)).map(r=>r===routeData[12]?{...r,points:r.points.map(([u,v])=>u===1064?[1069,572] as Point:[u,v] as Point)}:r),
 ...
 route('西三食堂—中环西路连接路',10,[[-270,-125],[-270,-108],[-270,-82],[-270,-55],[-270,-35]]),
 route('体育馆—中环西路连接路',10,[[-220,38],[-220,-30],[-220,-92],[-220,-120],[-220,-145]]),
 // The gym/tennis connector meets 环教北路, not the external middle ring.
 route('体育馆—网球场连接路',9,[[-260,-66],[-260,18],[-260,50],[-260,82],[-260,140]]),
